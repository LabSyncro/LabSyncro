...
<template>
  <nav
    class="bg-tertiary-darker flex justify-center sm:justify-start md:pl-28 text-white items-stretch text-normal md:text-lg">
    <div ref="dropdown">
      <button
...
aria-hidden
      ...
      <DeviceDropdown :active="isDropdownActive" @link-click="toggleDropdown" />
    </div>
